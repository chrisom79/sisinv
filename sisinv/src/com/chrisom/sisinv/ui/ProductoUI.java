...
public class ProductoUI {
	...
	public Window createWindowSrch() {
		...
		PagedTable result = new PagedTable();
		...
		content.addComponent(result.createControls());
	...
	private Button createSearchButton(IndexedContainer container, PagedTable table) {
	...
	private TextField createIdSearchField(IndexedContainer container, PagedTable table){
	...
	private Button createRemoveButton(PagedTable table, Object id, String code) {
		Button button = new Button();
